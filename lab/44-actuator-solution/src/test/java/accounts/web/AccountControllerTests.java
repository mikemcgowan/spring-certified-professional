...
public class AccountControllerTests {
    ...
    public void setUp() throws Exception {
        ...
        doReturn(counter).when(registry)
                         .counter(any(String.class), any(String.class), any(String.class));
    ...
    public void testCreateAccount() {
        ...
        assertEquals("http://localhost/accounts/3",
                     result.getHeaders()
                           .getLocation()
                           .toString());
    }
    ...
    public void testAddBeneficiary() {
        ...
        assertNotNull(result);
        assertEquals("http://localhost/accounts/0/beneficiaries/Test2",
                     result.getHeaders()
                           .getLocation()
                           .toString());
    }
