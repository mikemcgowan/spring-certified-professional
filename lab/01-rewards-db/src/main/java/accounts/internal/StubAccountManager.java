...
public class StubAccountManager extends AbstractAccountManager {
    ...
    public StubAccountManager() {
        ...
        account.getBeneficiary(TEST_BEN0_NAME)
               .setEntityId(TEST_BEN0_ID);
        account.getBeneficiary(TEST_BEN1_NAME)
               .setEntityId(TEST_BEN1_ID);
    ...
    public void removeBeneficiary(Long accountId, String beneficiaryName,
        ...
        accountsById.get(accountId)
                    .removeBeneficiary(beneficiaryName);
