...
public abstract class AbstractAccountManagerTests {
    ...
    public void getAccount() {
        ...
        assertEquals(account.getEntityId()
                            .longValue(), 0L, "wrong entity id");
        ...
        assertEquals(2,
                     account.getBeneficiaries()
                            .size(),
                     "wrong beneficiary collection size");
    ...
    public void addAccount() {
        ...
        if (accountManager instanceof JpaAccountManager
            && this.getClass()
                   .getAnnotation(ContextConfiguration.class) == null) {
            return;
        }
        ...
        assertEquals(getNumAccountsExpected() + 1,
        ...
        assertEquals(1,
                     newAccount.getBeneficiaries()
                               .size(),
                     "Did not save beneficiary");
    }
    ...
    public void updateAccountBeneficiaries() {
        ...
        assertEquals(Percentage.valueOf("25%"),
                     account.getBeneficiary("Annabelle")
                            .getAllocationPercentage(), "Invalid adjusted percentage");
        assertEquals(Percentage.valueOf("75%"),
                     account.getBeneficiary("Corgan")
                            .getAllocationPercentage(), "Invalid adjusted percentage");
    }
    ...
    public void addBeneficiary() {
        ...
        assertEquals(3,
                     account.getBeneficiaries()
                            .size(),
                     "Should only have three beneficiaries");
    }
    ...
    public void removeBeneficiary() {
        ...
        assertEquals(1,
                     account.getBeneficiaries()
                            .size(),
                     "Should only have one beneficiary");
        assertEquals(Percentage.oneHundred(),
                     account.getBeneficiary("Corgan")
                            .getAllocationPercentage(), "Corgan should now have 100% allocation");
    }
}
